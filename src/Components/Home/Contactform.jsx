        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-6'>
          <a href='https://pmfby.gov.in/'>
            <div className='border-solid border-gray-50 h-60 w-60px bg-gray-700 rounded-lg p-5 shadow-2xl hover:bg-gray-600'>
              ...
              <p className='text-green-500'>
                Launched in 2020, the Pradhan Mantri Fasal Bima Yojana (PMFBY)
                is an Indian government crop insurance scheme. It shields
                farmers from natural disasters, pests, and diseases, with
                affordable premiums and government subsidies. This program
                bolsters agricultural sustainability and food security.
              </p>
            </div>
          </a>
          ...
          <a href='https://pmksy.gov.in/'>
            <div className='border-solid border-gray-50 h-60 w-60px bg-gray-700 rounded-lg p-5 shadow-2xl hover:bg-gray-600'>
              ...
              <p className='text-green-500'>
                Launched in 2020, the Pradhan Mantri Krishi Sinchai Yojana
                (PMKSY) is an Indian government initiative to improve irrigation
                efficiency, water management, and crop yields through water
                resource development and micro-irrigation systems while
        ...
        <div className='w-1/3'>
          ...
          <div className='py-3 mt-5'>
            ...
            <h1 className='text-green-500 text-s hover:underline'>
              <a href='mailto:agroinvest101@gmail.com'>
                dhruvraj9987@gmail.com
              </a>
            </h1>
          </div>
          <div className='py-3'>
            <h1 className='font-bold text-l'>AgriInvest India</h1>
            <h1 className='text-gray-500 text-s italic'>
              AgriInvest India pvt ltd., Dadar West, Mumbai-400002
            </h1>
          </div>
          <div className='py-3'>
            <h1 className='font-bold text-l'>Verification of Employment</h1>
            <h1 className='text-gray-400 text-s'>
              Want to enquire about job opportunities @AgriInvest? mail here -
            </h1>
            <h1 className='text-green-500 text-s hover:underline'>
              <a href='mailto:agroinvest101@gmail.com'>
                dhruvraj9987@gmail.com
